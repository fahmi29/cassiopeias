...
import { Card, Image, Row, Col, Button, ButtonGroup, Form, Container, Navbar, Nav, NavDropdown, Dropdown, DropdownButton } from "react-bootstrap";
    ...
    render(){
        return(
            <>
                ...
                <Container fluid style={{padding: '5%', backgroundColor:'#F5F0E5'}}>
                    <Row className="justify-content-center">
                        <Col md={2}>
                            <Row>
                                <Col sm={12} style={{paddingBottom:'13%'}}>
                                    <Image style={{width: '100%'}} src={Cupcakes_chocholate} />
                                </Col>
                                <Col sm={12} style={{paddingBottom:'13%'}}>
                                    <Image style={{width: '100%'}} src={Cupcakes_chocholate} />
                                </Col>
                        ...
                        <Col md={5}>
                                <Image style={{width: '100%', height:'94%'}} src={Cupcakes_chocholate} />
                        </Col>
                        <Col md={5}>
                            <p style={{ color:'#9F9C9A', fontSize: '13px'}}>cakes & specials {">"} whole cakes</p>
                                    <h4>Chocolate signature</h4>
                                    <h4 style={{ color:'#BB802B'}}>Rp. 350.000</h4>
                                    <p>MUST TRY! An amused feeling comes from the scrumptious taste of Tiramisu, Black Forest, Red Velvet, Vanilla Fruit, and Choco De Ville</p>
                                    <Form>
                                        <Form.Group as={Row}>
                                            ...
                                            <Col sm={9}>
                                                <Form.Control as="select" defaultValue="D20" style={{width: '28%', backgroundColor:'#F5F0E5'}}>
                                                    <option>D20</option>
                                                </Form.Control>
                                            </Col>
                                        </Form.Group>
                                        <Form.Group as={Row}>
                                            ...
                                            <Col sm={3}>
                                                <Form.Control type="number" style={{ backgroundColor:'#F5F0E5' }}/>
                                            </Col>
                                            <Form.Label column sm={6}>12 piece available</Form.Label>
                                        </Form.Group>
                                        <Form.Group>
                                            <Form.Control as="textarea" rows={3} placeholder="You can put wording on your cake for FREE (Max 25 Characters)" />
                                        </Form.Group>
                                    </Form>
                            <Button variant="outline-dark">Add to Chart</Button>
                            <Button variant="dark" className="ml-1">Buy Now</Button>
                        </Col>
                    </Row>

                <Row style={{marginTop: '5%', fontSize: '2rem', fontWeight: 'bold', textTransform: 'uppercase'}} className="justify-content-center">Related Product</Row>
                <hr style={{width: '15%', borderBottom: '2px solid black'}} className="justify-content-center" />
                {/* <Row style={{width: '40%', borderBottom: '1px solid black'}} className="justify-content-center">_</Row> */}
                {/* <Card>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro est in, incidunt voluptatibus molestiae eum rem harum impedit aliquid corrupti iure? Voluptates aliquam totam tempora. Ut reprehenderit quam vero tempora.</Card> */}
                <Cake />
                </Container>
            </>
        )

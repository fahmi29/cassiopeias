...
import { Card, Col, Row, Button, Navbar, Nav, NavDropdown, DropdownButton, ButtonGroup, Dropdown, Form } from "react-bootstrap";
...
class Blog extends Component {
    ...
    render(){
        ...
        <>
            ...
            <Nav style={{padding:'3%',backgroundColor:'#F5F0E5'}} className="justify-content-center">
                <h3>The Harvest Cake Blog</h3>
            </Nav>
                ...
                <Row style={{marginRight: 0}}>
                    <Col sm="4">
                        <Card style={{border: 'none' }}>
                            <Card.Body>
                                <Button variant="light" style={{backgroundColor: '#ad6600', borderRadius: '10rem', color: 'white'}} rounded onClick={() => {this.changeURL('/detailblog/1')}}>APR 7, 2021</Button>
                                <Card.Text style={{fontWeight: 'bold', fontSize: '14px', cursor: 'pointer'}} onClick={() => {this.changeURL('/detailblog/1')}}>Snack Box, Coffee Break, Hamper & Gifts, Hot Meals untuk Pesanan Korporat</Card.Text>
                            </Card.Body>
                            <Card.Img variant="bottom" src={BusinessCatalog} />
                        </Card>
                    </Col>
                    <Col sm="4">
                        <Card style={{ border: 'none' }}>
                            <Card.Body>
                                <Button variant="light" style={{backgroundColor: '#ad6600', borderRadius: '10rem', color: 'white'}} rounded onClick={() => {this.changeURL('/detailblog/2')}}>APR 7, 2021</Button>
                                <Card.Text style={{fontWeight: 'bold', fontSize: '14px', cursor: 'pointer'}} onClick={() => {this.changeURL('/detailblog/2')}}>Snack Box, Coffee Break, Hamper & Gifts, Hot Meals untuk Pesanan Korporat</Card.Text>
                            </Card.Body>
                            <Card.Img variant="bottom" src={BusinessCatalog} />
                        </Card>
                    </Col>
                    <Col sm="4">
                        <Card style={{ border: 'none' }}>
                            <Card.Body>
                                <Button variant="light" style={{backgroundColor: '#ad6600', borderRadius: '10rem', color: 'white'}} rounded onClick={() => {this.changeURL('/detailblog/3')}}>APR 7, 2021</Button>
                                <Card.Text style={{fontWeight: 'bold', fontSize: '14px', cursor: 'pointer'}} onClick={() => {this.changeURL('/detailblog/3')}}>Snack Box, Coffee Break, Hamper & Gifts, Hot Meals untuk Pesanan Korporat</Card.Text>
                            </Card.Body>
                            <Card.Img variant="bottom" src={BusinessCatalog} />
                        </Card>
                    </Col>

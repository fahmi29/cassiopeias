...
import { Form, Button, ButtonGroup, Row, Col, Container, Tabs, Tab, Navbar, Nav, NavDropdown, DropdownButton, Dropdown } from 'react-bootstrap';
// import {  Carousel, Form, FormControl, Button, Row, Col, Card, Image, Container, Modal, DropdownButton, Dropdown, ButtonGroup, InputGroup } from 'react-bootstrap';
                ...
                <Navbar expand="lg">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <Nav className="mr-4">
                                ...
                                <Button id="login" variant="dark" className="ml-1" onClick={this.onOpenLogin}>
                                    Login / Register
                                </Button>
                    ...
                    <Container>
                        <Row>
                            <Col>
                                <Tabs defaultActiveKey={this.props.location.state.login === true ? 'login' : 'register'} id="controlled-tab-example" className="justify-content-center">
                                            ...
                                            <Col xs={9} md={6}>
                                                ...
                                                <Row className="justify-content-center">
                                                    <ButtonGroup vertical>
                                                        <Button variant="info">
                                                            <svg width="13" height="24" viewBox="0 0 13 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.39937 23.5514V12.8127H11.9086L12.4351 8.62637H8.39937V5.95402C8.39937 4.74237 8.72573 3.91664 10.4199 3.91664L12.5771 3.91573V0.171347C12.2041 0.12157 10.9235 0.00744629 9.43299 0.00744629C6.3206 0.00744629 4.18981 1.95802 4.18981 5.53941V8.62637H0.669922V12.8127H4.18981V23.5514H8.39937Z" fill="white"/></svg>
                                                            &nbsp;<i>Login with Facebook</i>
                                                        </Button><br />
                                                        <Button variant="danger">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.78113 22.3779C4.79485 22.3779 0.738281 18.3214 0.738281 13.3351C0.738281 8.349 4.79485 4.2923 9.78113 4.2923C11.3914 4.2923 12.9728 4.72118 14.3542 5.53238L14.8887 5.84645L12.9125 9.71996L12.3029 9.33475C11.5495 8.85849 10.6775 8.6069 9.78113 8.6069C7.1738 8.6069 5.05289 10.728 5.05289 13.3351C5.05289 15.9425 7.1738 18.0635 9.78113 18.0635C10.7662 18.0635 11.7327 17.7592 12.5026 17.2065C13.006 16.8451 13.4125 16.3855 13.6932 15.8696L9.56181 15.8694V11.7438H18.7061L18.7688 12.332C18.8042 12.6659 18.8238 13.0222 18.8238 13.3351C18.8238 18.3214 14.7673 22.3779 9.78113 22.3779Z" fill="white"/></svg>
                                                            &nbsp;<i>Login with Google</i>
                                                        </Button>
                                                    </ButtonGroup>
                                                </Row>
                                                <h5 className="text-center">------<span>or</span>-------</h5>
                                                <Row className="justify-content-center">
                                                    <Col>
                                                        <Fragment>
                                                            <Form>
                                                                ...
                                                                <Form.Group controlId="formBasicPassword">
                                                                    <Form.Label>Password <i style={{color: 'red'}}>*</i></Form.Label>
                                                                ...
                                                                <Form.Group>
                                                                    <br></br>
                                                                    <Form.Label style={{float: 'right'}}><a className="blue-text" style={{ color: "#219ddb" }}>Forgot Password</a></Form.Label>
                                                                </Form.Group>
                                                            </Form>
                                                        </Fragment>
                                                    </Col>
                                    ...
                                    <Tab eventKey="register" title="Register">
                                        <Row>
                                            <Col>
                                                ...
                                                <Fragment>
                                                    <h4 style={{color: '#AD6701'}}>PERSONAL DETAILS</h4>
                                                    <Form>
                                                        <Form.Row>
                                                            <Form.Group as={Col}>
                                                                <Form.Label>Frist Name <i style={{color: 'red'}}>*</i></Form.Label>
                                                        ...
                                                        <Form.Row>
                                                            <Form.Group as={Col}>
                                                                ...
                                                                <Form.Control placeholder="First Name" onChange={(event) => { this.setState({ first_name: event.target.value, }); }} as="select">
                                                                    <option>Male</option>
                                                            ...
                                                            <Form.Group as={Col}>
                                                                ...
                                                                <Form.Control type="date" onChange={(event) => { this.setState({ last_name: event.target.value, }); }} />
                                                            </Form.Group>
                                                        </Form.Row>
                                                        
                                                        <h4 style={{color: '#AD6701'}}>PASSWORD DETAILS</h4>
                                            ...
                                            <Col className="mt-4">
                                                <Fragment>
                                                    <h4 style={{color: '#AD6701'}}>ADDRESS DETAILS</h4>
                                                    <Form>

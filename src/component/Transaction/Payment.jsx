...
import { Accordion, Button, Col, Collapse, Form, Image, InputGroup, Nav, Row, Table } from 'react-bootstrap';
import Navigation from "../Navigation/Navigation";
import bni from "../../components/image/bni.png";
                            ...
                            <Row>
                                ...
                                <Col md={12}>
                                    <Row>
                                        ...
                                        <Col md={4}>
                                            <Button variant="primary" style={{float: 'right'}} onClick={() => {this.changeURL('/addpayment')}}><b style={{ fontSize: '24px'}}>+</b> Add new payment</Button>
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
                        ...
                        <Table fluid>
                            ...
                            <tbody>
                                <tr style={{backgroundColor: '#FFFFFF'}}>
                                    <td>IN8292073</td>
                                    <td><p>Leni Sudirman</p> <p>08962819016</p></td>
                                    <td style={{width: '150px'}}>
                                        <tr><Image src={bni} style={{ width: '150px', height: '50px' }} /></tr>
                                        <p>Bank Transfer</p>
                                    </td>
                                    <td>cvd</td>
                                    <td>cvd</td>
                                    <td><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.4766 26C8.95649 26 6.90625 23.9498 6.90625 21.4297V6.09375C6.90625 2.73366 9.63991 0 13 0C16.3601 0 19.0938 2.73366 19.0938 6.09375V21.4297H17.5703V6.09375C17.5703 3.57368 15.5201 1.52344 13 1.52344C10.4799 1.52344 8.42969 3.57368 8.42969 6.09375V21.4297C8.42969 23.1097 9.79652 24.4766 11.4766 24.4766C13.1566 24.4766 14.5234 23.1097 14.5234 21.4297V9.14062C14.5234 8.3006 13.84 7.61719 13 7.61719C12.16 7.61719 11.4766 8.3006 11.4766 9.14062V21.4297H9.95312V9.14062C9.95312 7.46058 11.32 6.09375 13 6.09375C14.68 6.09375 16.0469 7.46058 16.0469 9.14062V21.4297C16.0469 23.9498 13.9966 26 11.4766 26Z" fill="black"/></svg></td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </Table>

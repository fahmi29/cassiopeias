...
import { Card, Col, Form, Row, Button, Nav, Navbar, NavDropdown, DropdownButton, Dropdown, ButtonGroup } from "react-bootstrap";
        ...
        return(
            <>
                        ...
                        <Navbar expand="lg">
                            ...
                            <Navbar.Collapse id="basic-navbar-nav">
                                <Nav className="mr-auto">
                                    ...
                                    <Nav.Link onClick={() => {this.changeURL('blog')}}>BLOG</Nav.Link>
                                    <Nav.Link>|</Nav.Link>
                                ...
                                <Nav className="mr-4">
                                    <Form>
                                        <a id="chart" className="btn" href="/chart">
                ...
                <Nav style={{padding:'5%',backgroundColor:'#F5F0E5'}}>
                    <h3 className="text-center">Birthday Cakes</h3>
                    <p className="ml-5" style={{width: '95%'}}>Birthday cakes from Harvest Cakes are irresistible. We have an assortment of sumptuous freshly baked cakes infused with toothsome flavors to make your birthday memorable. Birthday is a special occasion where you convey your heartfelt 'happy birthday' wishes to your loved ones, and you can do it best with our colorful range of unique birthday cakes/Kue Ulang Tahun Unik. Harvest Cakes offers all kinds of party supplies online, like greetings cards, balloons, and personalized messages to add flavors of joy to your birthday party. Buy your favorite birthday cake today, and enjoy our quick delivery service.</p>
                </Nav>
                <Card>
                    <Card.Body>
                        <Row>
                            <Col md={10}>
                                <h3 className="card-title ml-5">All Product</h3>
                                <hr style={{borderBottom: '1px solid black', width: '15%', float: 'left'}} className="ml-5" />
                            </Col>
                            <Col md={10}>
                                <Row>
                                    <Col sm="4  ">
                            ...
                            <Col>
                                <Form style={{backgroundColor:'#F5F0E5'}}>
                                    <Form.Group>
                                        <Button variant="light" style={{backgroundColor: '#AD6701', color: 'white' }} onClick={this.onOpenLocation} block>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.1223 0C9.83521 0 9.53586 0.009552 9.24627 0.0278235H8.89302C8.79733 0.0278235 8.70347 0.0482858 8.61356 0.0893418C6.3996 0.133509 4.5069 1.34157 3.66598 3.25105C2.84096 5.12408 3.23675 7.25172 3.60612 8.68916C4.45516 11.9941 6.38637 15.5447 8.95892 18.5756C8.62671 18.5671 8.29519 18.5584 7.96714 18.5495C7.42513 18.5351 6.88312 18.5208 6.34089 18.5079H6.31574C5.82933 18.5079 5.57068 18.8412 5.56691 19.1705C5.56279 19.5118 5.82368 19.8634 6.33007 19.8749C6.87173 19.8877 7.41308 19.9021 7.95465 19.9166C9.50089 19.9575 11.0998 20 12.6744 20C13.127 20 13.5795 19.9969 14.0325 19.9889C14.5385 19.98 14.8004 19.6301 14.797 19.2898C14.7942 18.9578 14.5345 18.6218 14.0247 18.6218C14.0247 18.6218 14.0245 18.6218 14.0243 18.6218C13.5744 18.6299 13.1241 18.633 12.6742 18.633C12.309 18.633 11.9426 18.6303 11.5755 18.6263C14.3216 15.7016 16.2836 11.5001 16.752 7.47041C16.9275 5.96277 16.851 3.79964 15.4911 2.05692C14.4266 0.692169 12.6201 0 10.1223 0ZM15.2928 7.90919C14.7488 11.5459 12.8327 15.376 10.273 17.9615C8.24603 15.6341 6.5803 12.8377 5.44913 9.86025C4.69387 7.87199 4.43544 6.21384 4.65939 4.79028C4.9661 2.84273 6.65299 1.48227 8.76193 1.48227C8.80364 1.48227 8.84522 1.48271 8.9063 1.48415C9.0052 1.48415 9.09909 1.46426 9.18585 1.42487H9.42281C9.46763 1.42487 9.51347 1.41987 9.56175 1.40962C9.74933 1.4016 9.93796 1.39731 10.1265 1.39731C12.1319 1.39731 13.553 1.92473 14.4717 3.01019C15.3478 4.04523 15.6241 5.69343 15.2928 7.90919Z" fill="white"/><path d="M10.0143 2.20433C9.97103 2.20433 9.92787 2.20476 9.89939 2.20621C7.83427 2.12344 6.32961 3.43829 6.19479 5.41643C6.04003 7.68135 8.08582 9.36145 10.0936 9.50928C10.1822 9.51594 10.2716 9.5191 10.3606 9.5191C10.3606 9.5191 10.3606 9.5191 10.3609 9.5191C12.3418 9.5191 14.2261 7.98421 14.476 6.16713C14.6012 5.25558 14.3543 4.41443 13.7615 3.73453C12.9512 2.80496 11.4802 2.20433 10.0143 2.20433ZM12.9866 6.03801C12.8193 7.25466 11.3703 8.00791 10.1117 8.00791C8.64799 8.00156 7.77621 6.76957 7.77875 5.5821C7.78055 4.67553 8.30232 3.70675 9.76088 3.70675C9.78844 3.70675 9.81605 3.70697 9.84865 3.70785C9.85631 3.70828 9.86411 3.7085 9.87147 3.70828C9.91218 3.70719 9.95345 3.70649 9.99495 3.70649C10.807 3.70649 11.9771 3.96071 12.6021 4.67751C12.9296 5.05297 13.0586 5.51098 12.9866 6.03801Z" fill="white"/></svg>
                                            Choose Location
                                        </Button>
                                    </Form.Group>
                                    <Form.Group>
                                        <Button variant="outline-light" style={{border: '1px solid #AD6701', color: '#AD6701' }} onClick={this.onOpenLocation} block>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0)"><path d="M14.4946 8.0988L5.84719 8.06103C5.55169 9.2012 4.38785 9.88594 3.24765 9.59044C2.49151 9.39447 1.903 8.8008 1.71364 8.04298L0.566176 8.03796C0.270302 8.03667 0.0315045 7.79578 0.0327968 7.4999C0.0340891 7.20403 0.274981 6.96526 0.570856 6.96656L1.71835 6.97157C2.01384 5.8314 3.17769 5.14666 4.31789 5.44215C5.07403 5.63813 5.66254 6.2318 5.8519 6.98962L14.4993 7.02739C14.7951 7.02868 15.0339 7.26958 15.0327 7.56545C15.0314 7.86132 14.7905 8.10009 14.4946 8.0988ZM3.78745 6.44488C3.19573 6.44229 2.71395 6.91989 2.71136 7.5116C2.70878 8.10332 3.18637 8.58511 3.77809 8.58769C4.36981 8.59028 4.85159 8.11268 4.85418 7.52096C4.85676 6.92924 4.37917 6.44746 3.78745 6.44488Z" fill="#AC6700"/><path d="M14.4712 13.4562L12.788 13.4489C12.4925 14.589 11.3286 15.2738 10.1884 14.9783C9.4323 14.7823 8.84379 14.1886 8.65443 13.4308L0.542739 13.3954C0.246864 13.3941 0.00806703 13.1532 0.00935931 12.8573C0.0106516 12.5615 0.251544 12.3227 0.547418 12.3239L8.65911 12.3594C8.9546 11.2192 10.1184 10.5345 11.2586 10.83C12.0148 11.0259 12.6033 11.6196 12.7927 12.3774L14.4758 12.3848C14.7717 12.3861 15.0105 12.627 15.0092 12.9228C15.0079 13.2187 14.767 13.4575 14.4712 13.4562ZM10.7282 11.8327C10.1365 11.8301 9.65473 12.3077 9.65215 12.8994C9.64956 13.4912 10.1272 13.9729 10.7189 13.9755C11.3106 13.9781 11.7924 13.5005 11.795 12.9088C11.7975 12.3171 11.32 11.8353 10.7282 11.8327Z" fill="#AC6700"/><path d="M14.518 2.74174L11.7634 2.72971C11.4679 3.86988 10.3041 4.55462 9.16387 4.25913C8.40773 4.06315 7.81922 3.46948 7.62986 2.71166L0.589614 2.68091C0.293739 2.67962 0.054942 2.43872 0.0562342 2.14288C0.0575263 1.84704 0.298419 1.60821 0.594293 1.6095L7.63457 1.64025C7.93007 0.500082 9.09392 -0.184658 10.2341 0.110834C10.9903 0.306808 11.5788 0.90048 11.7681 1.6583L14.5227 1.67034C14.8186 1.67163 15.0574 1.91252 15.0561 2.20839C15.0548 2.50427 14.8139 2.74304 14.518 2.74174ZM9.70367 1.11356C9.11196 1.11097 8.63017 1.58857 8.62759 2.18028C8.625 2.772 9.1026 3.25379 9.69431 3.25637C10.286 3.25896 10.7678 2.78136 10.7704 2.18964C10.773 1.59793 10.2954 1.11614 9.70367 1.11356Z" fill="#AC6700"/></g><defs><clipPath id="clip0"><rect width="15" height="15" fill="white" transform="matrix(0.99999 0.00436764 0.00436764 -0.99999 0 14.9999)"/></clipPath></defs></svg>
                                            Filter
                                        </Button>
                                    </Form.Group>
                                    <Form.Group>
                                    ...
                                    <Form.Group>
                                        <h3 className="card-title" style={{fontWeight: 'bold'}}>Categories</h3>

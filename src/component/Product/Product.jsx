...
import { Accordion, Button, Card, Col, Collapse, Form, Image, InputGroup, Nav, Row, Table } from 'react-bootstrap';
import Navigation from "../Navigation/Navigation";
import Coklat from "../../components/image/happy-birthday-cake-pink.jpg";
                            ...
                            <Row>
                                ...
                                <Col md={12}>
                                    <Row>
                                        ...
                                        <Col md={4}>
                                            <Button variant="primary" style={{float: 'right'}} onClick={() => {this.changeURL('/addproduct')}}><b>+</b> Add new product</Button>
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
                            ...
                            <Col md={3}>
                                <Card style={{backgroundColor: 'transparent', border: 'none'}}>
                                    <Card.Body className="text-center">
                                        <Image src={Coklat} style={{borderRadius: '50%', width: '100px', height: '100px'}} />
                                            <p style={{fontWeight: 'bold'}}>Thaitea Cheesecake</p>
                                            <p>Birthday Cake</p>
                                    </Card.Body>
                                </Card>
                            </Col>
